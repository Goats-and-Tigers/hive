(() => {
  ...
  function expose(obj2, ep = self) {
    ep.addEventListener("message", function callback(ev) {
      ...
      try {
        const parent = path
          .slice(0, -1)
          .reduce((obj3, prop) => obj3[prop], obj2);
  ...
  // bees-engine/bees/pkg/snippets/wasm-bindgen-rayon-7afa899f36665473/src/workerHelpers.no-bundler.js
  var import_meta = {};
  ...
  // bees-engine/bees/pkg/gt_engine.js
  var import_meta2 = {};
  var wasm;
  ...
  async function init(input, maybe_memory) {
    ...
    imports.wbg.__wbg_startWorkers_3e6644f7fc0ac450 = function (
      arg0,
      arg1,
      arg2
    ) {
